...
def create_ingredient():
    response, status_code = execute_command(CreateCommand, IngredientReceiver, request.json)
    return response, status_code


@ingredient.route('/', methods=PUT)
def update_ingredient():
    response, status_code = execute_command(UpdateCommand, IngredientReceiver, request.json)
    return response, status_code
