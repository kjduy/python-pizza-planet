...
def test_update_size_service(client, create_size, size_uri):
    ...
    pytest.assume(updated_size[param] == value for param, value in update_data.items())
...
def test_get_size_by_id_service(client, create_size, size_uri):
    ...
    pytest.assume(returned_size[param] == value for param, value in current_size.items())
...
def test_get_size_service(client, create_sizes, size_uri):
    ...
    pytest.assume(size['_id'] in returned_sizes for size in create_sizes)
